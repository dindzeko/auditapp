...
def app():
    ...
    st.write("Ini adalah halaman untuk pencarian dengan toleransi typo. Masukkan file excel dengan nama kolom Data dan file lainnya dengan nama kolom Target. case senstif jangan sampai salah")
