...
def app():
    ...
    if uploaded_population:
        try:
            ...
            if 'Value' not in population_df.columns:
                st.error("File Excel harus memiliki kolom 'Value'.")
            else:
    ...
    if population_df is not None and 'Value' in population_df.columns:
    ...
    if uploaded_sample:
        try:
            ...
            if 'Misstatement' not in sample_filled_df.columns:
                st.error("File Excel harus memiliki kolom 'Misstatement'.")
            else:
    ...
    if sample_filled_df is not None and 'Misstatement' in sample_filled_df.columns:
