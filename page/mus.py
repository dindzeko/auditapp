 ...
 # Toggle Description Widget dengan tanda panah bawah/atas
    with st.expander("Klik untuk membaca deskripsi aplikasi 👇"):
        ...
        **Deskripsi Aplikasi:**
        ...
        4. Besaran sample mengikuti risk audit dan dihitung sesuai dengan rumus Juknis Uji Petik BPK (Halaman 35)
    ...
    if population_df is not None and sample_size is not None:
        ...
        use_random_start = st.checkbox("klik jika ingin gunakan angka random?", value=True)
